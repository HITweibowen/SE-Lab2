...
<body style="text-align:center">
	<h1 style="text-align:center">添加图书</h1>
		<center>
		    <s:form action="AddBook" style="font-size:30px; font-family:\"楷体\"">
		        ...
		        <s:textfield name="Isbn" label="Isbn码" style="font-size:30px; font-family:\"楷体\""/>
		        ...
		        <s:submit value="添加" style="text-align:center; font-size:25px; font-family:\"楷体\"" />
		    </s:form>
		</center>
	</body>
</html>